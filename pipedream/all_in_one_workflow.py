...
# Fetches "Team Leave & Events", formats summary, and sends to WhatsApp via Green API.
#
# Instructions:
...
# Target Calendar & Green API Configuration (configurable via environment variables)
CALENDAR_ID = os.environ.get("CALENDAR_ID", "your_calendar_id@group.calendar.google.com")
