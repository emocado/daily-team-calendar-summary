...
class SummaryFormatterTests(unittest.TestCase):
    ...
    def test_format_calendar_summary_with_events(self):
        ...
        text = format_calendar_summary(events, self.target_date, calendar_name="Team Leave & Events")

        self.assertIn("Team Calendar Summary: Team Leave & Events", text)
    ...
    def test_format_empty_days(self):
        text = format_calendar_summary([], self.target_date, calendar_name="Team Leave & Events")
