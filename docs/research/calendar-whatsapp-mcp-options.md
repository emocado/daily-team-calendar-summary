...
1. Resolve and pin the exact ID of **SW Leave & Events** (the visible calendar name; confirm whether this is the calendar the user called **SW Live Events**).
...
Daily scheduler (08:00 Asia/Singapore)
  -> Google hosted Calendar MCP (read-only OAuth)
     -> pinned calendar ID for SW Leave & Events
